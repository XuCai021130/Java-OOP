...
* 3,29,2022
* PA4
* Explanation: This code contains the main function, which is a race car simulation. 
* User can design their own car with the speed, strength and type of car they want.
* KnownBug: After the console said the race has started, nothing happened after that.
*/
package main;
...
public class SimulationDriverC {
	...
	/**
	 * 	This is the main function where the race car simulation happens
	 * @param args
	 */
